...
const ProjectCard = ({
	...
	return (
		...
		>
			<a
				className="group flex items-start gap-2 overflow-hidden text-ellipsis py-1 text-lg font-semibold leading-none underline-offset-4 hover:underline"
			...
			<MenuTrigger>
				...
				<Popover placement="bottom end">
					<Menu className="w-24 overflow-hidden rounded-md bg-neutral-100 text-sm font-medium text-black outline-none *:flex *:cursor-pointer *:items-center *:gap-2 *:p-2 [&_*:focus-visible]:bg-neutral-200 [&_*]:outline-none [&_svg]:size-4 [&_svg]:shrink-0">
